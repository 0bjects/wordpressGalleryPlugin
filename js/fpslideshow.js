...
var fullpageslideshow={
	...
	init:function(options){
		...
		jQuery(function($){
			...
			var layers=$('<div class="slider" />').clone().andSelf().appendTo(document.body)
...
fullpageslideshow.init({ //initialize script
	...
	thumbdir: '', //sub directory directly below main images directory containing the thumbnail versions. Image names should be same as main images.
